...
void *pthread_fun(void *arg)
{
    ...
    // 通过获取的数据包中得到浏览器要访问的网页文件名,已sqlite下about.html为例
    // GET /about.html http/1.1
    char filename[128] = "";
    sscanf(buf, "GET /%s", filename); // sscanf函数与空格结束，所以直接可以获取文件名 about.html
...
//  服务端运行      ./webserver  192.168.169.128 9999
//  浏览器输入网址  http://192.168.169.128:9999/about.html
